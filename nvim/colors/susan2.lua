...
-- palette.darkgreen[1]   = "#68a888" -- _keyword, _macro
palette.darkgreen[1]   = "#20c880" -- _keyword, _macro
-- palette.green[1]       = "#a8c868" -- _function, _interface
palette.green[1]       = "#b8c848" -- _function, _interface
palette.magenta[1]     = "#c078e8" -- _var
palette.cyan[1]        = "#50a0e8" -- _string, _preproc
-- palette.red[1]         = "#e89080" -- _enum, _typeparam, _markup
palette.red[1]         = "#e868a0" -- _enum, _typeparam, _markup
