...
require "treesitter_highlight" {
    ...
    comment    = {10,  65, "#5f875f"}, -- green

    visual     = {10, 114, "#b0b087"}, -- bone
    text       = {10, 144, "#b0b087"}, -- bone
    identifier = {10, 144, "#b0b087"}, -- bone

    keyword    = { 9, 110, "#87a8d7"}, -- blue
    str        = { 9, 110, "#87a8d7"}, -- blue
    added      = { 9, 110, "#87a8d7"}, -- blue

    warnbg     = { 5,   5, "#141420"}, -- darkpurple
    warn       = {10, 140, "#b088d8"}, -- purple
    func       = {10, 140, "#b088d8"}, -- purple
    macro      = {10, 140, "#b088d8"}, -- purple
    changed    = {10,  10, "#b088d8"}, -- purple

    errorbg    = { 1, 1,   "#201414"}, -- darkred
    error      = { 9, 167, "#d87070"}, -- red
    type       = { 9, 167, "#d87070"}, -- red
    enum       = { 9, 167, "#d87070"}, -- red
    class      = { 9, 167, "#d87070"}, -- red
    struct     = { 9, 167, "#d87070"}, -- red
    removed    = { 9, 167, "#d87070"}, -- red
}
