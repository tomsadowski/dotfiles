return {
   ...
   --['@lsp.mod.defaultLibrary.rust']          = {link='Keyword'},
   -- ['@lsp.typemod.interface.defaultLibrary.rust'] = {link='Keyword'},
   -- ['@lsp.typemod.function.defaultLibrary.rust'] = {link='Keyword'},
    rustLifetime                              = {link='Normal'},
    ['@lsp.type.property.rust']               = {link='Normal'},
    ['@lsp.type.struct.rust']                 = {link='Structure'},
    rustEnum                                  = {link='Tag'},
    ['@lsp.type.enum.rust']                   = {link='Tag'},
    ['@lsp.type.enumMember.rust']             = {link='Tag'},
    ...
    ['@lsp.typemod.interface.library.rust']   = {link='@lsp'},
    ['@lsp.type.parameter.rust']              = {link='Label'},
